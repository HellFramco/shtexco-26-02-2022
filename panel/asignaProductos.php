...
<html style="overflow: hidden;">
    <center><img src="../imagenes/preloader_emp.gif" alt="" style="text-aling:center; width: auto; background-repeat:no-repeat; background-position:center; background-attachment:fixed; "></center>
</html>
<?php
  ...
  require_once("../modelo/db.php");
        ...
        if (
            ...
            0 == $_POST['tallaest']
                         ...
                         echo "<script>alert('No ha ingresado una cantidad de prendas.');
               ...
               echo "esto : ". $talla8Inventario. "--". $resul ."..";
                ...
                if (
                    ...
                    $tallaestInventario >= ($_POST['tallaest'] + $pedidoestInventario)
                        ...
                        echo "<script>alert('ha superado el limite de prendas para agregar.');
                        location.href = 'orden-nueva-venta-2.php?cliente=".$_POST['id_cliente']."&id_venta=".$_POST['id_venta']."&lista=true';</script>";
