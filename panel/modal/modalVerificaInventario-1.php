				...
				if (@$_POST['accion'] == 'verificarInventario') {
					...
					if (
						...
						echo "<h4 style='color:green;'>La actual entrada a bodega se ha verificado.</h4>";
							...
							$consulta = "UPDATE inventarios_productos SET verificado_bodega = 'SI', estado = 'EXISTENCIA', impresion_codigo_barras = 'SI', impresion_codigo_barras = 'SI', verificado = 1 WHERE id_inventario =".$_GET['id_inventario'];
							// $consulta = "UPDATE inventarios_productos SET verificado_bodega = 'SI', estado = 'EXISTENCIA' AND verificado = 1 WHERE id_inventario =".$_GET['id_inventario'];
							...
							if($modules){ 
								...
								foreach ($modulesDatos as $value) {
									...
									$reprogramacion = $value['reprogramacion'];


									$peso_talla6 = $value['peso_talla6'];
									$peso_talla8 = $value['peso_talla8'];
									$peso_talla10 = $value['peso_talla10'];
									$peso_talla12 = $value['peso_talla12'];
									$peso_talla14 = $value['peso_talla14'];
									$peso_talla16 = $value['peso_talla16'];
									$peso_talla18 = $value['peso_talla18'];
									$peso_talla20 = $value['peso_talla20'];
									$peso_talla26 = $value['peso_talla26'];
									$peso_talla28 = $value['peso_talla28'];
									$peso_talla30 = $value['peso_talla30'];
									$peso_talla32 = $value['peso_talla32'];
									$peso_talla34 = $value['peso_talla34'];
									$peso_talla36 = $value['peso_talla36'];
									$peso_talla38 = $value['peso_talla38'];
									$peso_tallas = $value['peso_tallas'];
									$peso_tallam = $value['peso_tallam'];
									$peso_tallal = $value['peso_tallal'];
									$peso_tallaxl = $value['peso_tallaxl'];
									$peso_tallau = $value['peso_tallau'];
									$peso_tallaest = $value['peso_tallaest'];
