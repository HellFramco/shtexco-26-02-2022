...
<form action="../../modelo/editarProducto.php" method="post">
	...
	<br>
		<div class="col-sm-12">
			<legend>Asignar ubicacion del Producto</legend>
		</div>
		<div class="col-sm-4">
			<label for="">Referencia
				<input type="text" required="" value="<?php echo $key['referencia']; ?>" placeholder="Referencia" name="referencia" id="referencia" class="form-control" readonly>
			</label>
			<label for="">Tipo
				<select type="text" required="" placeholder="tipo" name="tipo" id="tipo" class="form-control" readonly>
					<option value="<?php echo $key['tipo']; ?>"><?php echo $key['tipo']; ?></option>
					<!-- <?php $productos->select_tipos_inventarios(); ?> -->
				</select>
			</label>
			<label for="">coleccion
				<select type="text" required="" placeholder="coleccion" name="coleccion" id="coleccion" class="form-control" readonly>
			...
			<label for="">precio
				<input type="number" required="" value="<?php echo $key['precio']; ?>" placeholder="precio" name="precio" id="precio" class="form-control" readonly>
			</label>
		</div>
		<div class="col-sm-4">
			
			<label for="">Silueta
				<select type="text" required="" placeholder="silueta" name="silueta" id="silueta" class="form-control" readonly>
					<option value="<?php echo $key['silueta']; ?>"><?php echo $key['silueta']; ?></option>
					<!-- <?php $productos->select_siluetas(); ?> -->
				</select>
			</label>
			<label for="">categoria
				<select type="text" required="" placeholder="categoria" name="categoria" id="categoria" class="form-control" readonly>
					<option value="<?php echo $key['categoria']; ?>"><?php echo $key['categoria']; ?></option>
					<!-- <?php $productos->select_categorias(); ?> -->
				</select>
			</label>
			<label for="">color
				<select type="text" required="" placeholder="color" name="color" id="color" class="form-control" readonly>
					<option value="<?php echo $key['color']; ?>"><?php echo $key['color']; ?></option>
					<!-- <?php $productos->select_color(); ?> -->
				</select>
			</label>
			<label for="">genero
				<select type="text" required="" placeholder="genero" name="genero" id="genero" class="form-control" readonly>
		...
		<div class="col-sm-4">
			<label for="">Marca
				<select type="text" required="" placeholder="" name="marca" id="marca" class="form-control" readonly>
					<option value="<?php echo $key['marca']; ?>"><?php echo $key['marca']; ?></option>
					<!-- <?php $productos->select_marcas(); ?> -->
				</select>
			</label>
			<label for="">Tela
				<select type="text" required="" placeholder="" name="tela" id="telas" class="form-control" readonly>
					<option value="<?php echo $key['tela']; ?>"><?php echo $key['tela']; ?></option>
					<!-- <?php $productos->select_telas(); ?> -->
				</select>
			</label>
			<label for="">Proveedor
				<select type="text" required="" placeholder="" name="proveedor" id="proveedor" class="form-control" readonly>
