											...
											<div class="table-responsive">
												...
												<?php
																...
																<?php if ($_SESSION['typeUser']==1 || $_SESSION['typeUser']==7 || $_SESSION['typeUser']==3 || $_SESSION['typeUser']==8) {
																 ...
																 ?>
																 <input type="hidden" class="btn btn-danger bt-cancelar" id="cancelar_pedido" value="CANCELAR VENTA"> <!-- cancelar ventas  ->	<br><br><br><br>
																 <?php 
														...
														?>
															<form id="datosProductosSeleccionados" action="generarVenta.php?cliente=0&id_lista=0&id_venta=0&id_inventario=0&accion=generaVenta&id_cliente=0" method="post">
																...
																<?php if ($_SESSION['typeUser']==2 AND $permisoEstado =='INICIADA') {
																 ...
																 <br>
																 <br>
																 <a href="envio-correo.php?cliente=<?php echo $id_cliente; ?>&id_venta=<?php echo $_GET['id_venta'] ?>&accion=envioCorreo" class="btn btn-info" disabled>Enviar al Correo del cliente</a>
						...
						<div class="container">
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-sm-12">
										<br>
										<legend>Resultados de Busquedae</legend>
										<br>
