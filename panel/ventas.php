                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <tbody style="color: gray;">
                                        <?php
                                        foreach ($ventas->verVentas() as $key) {
                                        ?>
                                        <tr class="btn-light <?php echo $estadoVenta = $key['estado'] == 'CANCELADO'?'btn-danger':'btn-light'; ?>" style="text-transform: uppercase;">
                                            ...
                                            <th>
                                              <?php if ($_SESSION['typeUser']==8 or $_SESSION['typeUser']==1 or $_SESSION['typeUser']==7) {
                                                if ($key['estado']=='APROBO CLIENTE' or $key['estado']=='APROBO CARTERA' OR $key['estado']=='ININCIADA') {
                                                ?>
                                            ...
                                            <td class="text-center"><?php echo $ventas->verLineaUsuario($key['id_usuario']); ?></td>
                                            ...
                                            <td>
                                                <?php if ($key['cliente_aprobo']=='SI') { ?>
                                                    <img src="../imagenes/iconos/verificar.png" alt=""><br> <?php echo $key['fecha_cliente_aprobo'] ?>
                                                <?php } else { ?>
                                            ...
                                            <td>
                                                <?php if ($key['cartera_aprobo']=='SI') { ?>
                                                    <img src="../imagenes/iconos/verificar.png" alt=""><br> <?php echo $key['fecha_cartera_aprobo'] ?>
                                                <?php } else { ?>
                                            ...
                                            <td>
                                                <?php if ($key['alistamiento']=='SI') { ?>
                                                    <img title="Esta orden ya ha sido alistada por bodega" src="../imagenes/iconos/verificar.png" alt=""><br> <?php echo $key['fecha_alistamiento'] ?>
                                            ...
                                            <td>
                                                <?php if ($key['despachada']=='SI') { ?>
                                                    <img src="../imagenes/iconos/verificar.png" alt=""><br>
                                                    <?php echo $key['fecha_despacho'] ?>
                                            ...
                                            <td  class="d-flex" style="justify-content: center;">
                                                    ...
                                                    <?php
                                                    if ($key['estado'] == 'APROBO DESPACHO' && $_SESSION['typeUser'] == 4) {
                                                    ?>
                                                    <div class="offset-md-3">
                                                ...
                                                <td>
                                                    <?php
                                                    if ($key['estado'] == 'INICIADA' && $_SESSION['typeUser'] == 7) {
                                                    ?>
                                                    <div class="offset-md-3">
                                                        <a href="eliminar-venta-global.php?id_venta=<?php echo $key['id_venta']; ?>&accion=eliminarVenta" title="Eliminar esta orden iniciada."><img src="../imagenes/iconos/eliminar.png" alt=""></a>
                                                    </div>
                                                    <?php
                                                    }
                                                    ?>
                                                    ...
                                                    <?php if ($key['imagen_comprobante_pago'] != ''){ ?>
                                                        ...
                                                        <a href="#" class="" onclick="lista_comprobantes('<?php echo $key['id_venta']; ?>')"> Ver Comprobantes </i></a>
                                                        ...
                                                        <!-- <a href="comprobantes/<?php echo $key['imagen_comprobante_pago']; ?>" target="_blank"> Ver Comprobante</a> -->
                                                    <?php } else { echo "<i style='color:crimson;'>Pero No han subido el comprobante.</i>"; } ?>
                                                <?php } else { ?>
