                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                    ...
                    <tbody style="color: gray;">
                      ...
                      ?>
                        <tr style="background-color: <?php if($key['verificado']=='1'){ echo "#fff"; }else{ echo "#fff"; } ?>;">
                          ...
                          <td>
                            ...
                            ?>
                              <a class="btn btn-primary" id="imagen_subida_<?php echo $key['id_inventario']; ?>">confirmar imagen Existente</a>
                              <script type="text/javascript">
                                var imagen_subida_<?php echo $key['id_inventario']; ?> = document.getElementById('imagen_subida_<?php echo $key['id_inventario']; ?>');
                                imagen_subida_<?php echo $key['id_inventario']; ?>.addEventListener('click', function() {
                                  var confirmar_<?php echo $key['id_inventario']; ?> = confirm('Confirmas que ya Se ha subido la foto para la referencia: <?php echo $key['referencia']; ?> R<?php echo $key['reprogramacion']; ?>?');
                                  if (confirmar_<?php echo $key['id_inventario']; ?>) {
                                    location.href = '../modelo/confirmaImagenSubida.php?id=<?php echo $key['id_inventario']; ?>&accion=confirmaImagenSubida';
                                  } else {}
                                });
                              </script>
                            <?php
                          ...
                          <td>
                            <?php if ($key['confirma_imagen_subida'] == 1) {
                             ?>
                              <a class="thumbnail" href="#thumb"><img src="../imagenes/iconos/imagen.png" border="0" /><span><img src="../panel/modal/imagenesReferencias/<?php echo $key['id_inventario']; ?>.jpg"width="0px" height="0px" /></span></a>
                            <?php
                            }
                            else{
