								...
								<div class="col-sm-10">
									...
									<div class="col-sm-6">
										...
										<table width="100%" class="">
											...
											<tr>
												<td class="text-center"><input type="text" class="form-control text-center" id="cliente" readonly="" name="cliente" value="<?php echo $_GET['cliente']; ?>"></td>
												<?php foreach ($clientes->seleccionarIdCliente($_GET['cliente']) as $keyCliente) {
													...
													<tbody>
														...
														?>
															<form id="datosProductosSeleccionados" action="generarVenta.php?cliente=0&id_lista=0&id_venta=0&id_inventario=0&accion=generaVenta&id_cliente=0" method="post">
																...
																<?php if ($_SESSION['typeUser']==2 AND $permisoEstado =='INICIADA') {
																 ?>
	...
	<script>
		...
		function guardar_observacion(){
							...
							$.ajax({
                              ...
                              data: {'observacion':observacion, 'id_venta': id_venta, 'accion': 'registrar'},
                              success: function(r){
                               alert(r);
                              }
