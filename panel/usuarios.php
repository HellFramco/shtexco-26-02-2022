                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <tbody style="color: gray;" id="areaResultadosBusqueda">
                                        ...
                                        <?php
                                        foreach ($usuarios->verUsuarios() as $key) {
                                        ?>
                                            
                                            <tr class="btn-light" style="text-transform: uppercase;">
                                                <form action="../modelo/accionesUsuarios.php" method="POST">
                                                    <td><input type="text" value="<?php echo $key['mmb']; ?>" name="correo" class="form-control"> <?php echo $key['mmb']; ?></td>
                                                    <td><input type="text" value="<?php echo $key['nombre']; ?>" name="nombre" class="form-control"> <?php echo $key['nombre']; ?></td>
                                                    ...
                                                    <td>
                                                        <select name="linea" id="" class="form-control">
                                                            ...
                                                            <?php 
                                                            foreach ($usuarios->selectLineas() as $linea) {
                                                            ?>
                                                            <option value="<?php echo $linea['numero']; ?>"><?php echo $linea['numero']; ?></option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <td>
                                                        <a href="../modelo/eliminarUsuario.php?id=<?php echo $key['id']; ?>" class="btn btn-danger">Eliminar</a>
                                                    </td>
                                                    </form>
