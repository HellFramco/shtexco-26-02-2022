    ...
    foreach ($id_inventario as $resultado)
{
    ...
    echo "
        <script>
             ...
             location.href = 'orden-nueva-venta-2.php?cliente=".$id_cliente_resul."&id_venta=".$id_venta_resul."&lista=true';
        </script>
    ";
...
function descuenta($id_inventario, $id_venta, $id_cliente, $id_lista){
    ...
    if (
        ...
        //     $client = new WC_API_Client( 'https://www.drabbalovers.co/',
...
function valida($id_inventario, $id_venta, $id_cliente, $id_lista){
    ...
    foreach ($modulesInventario as $key) {
          ...
          echo $referencia = $key['referencia'];
        echo "Productos en inventario";
        echo "<br>";
        echo $talla6Inventario = $key['talla6'];
        echo "<br>";
        ...
        echo "
            <script> 
                console.log('Se ha acualizado el inventario'); 
                 location.href = 'orden-nueva-venta.php?cliente=".$id_cliente."&id_venta=".$id_venta."&lista=true';
            </script>";
