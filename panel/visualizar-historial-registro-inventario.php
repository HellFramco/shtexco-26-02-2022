...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div style="align-items: center;" class="row justify-content-between p-2">
                        <h1 class="h3 mb-2 text-gray-800"><a href="index.php">General</a> / Historial de Registro de inventario </h1>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="exampleEntrada" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>referencia</th>
                                                <th>Fecha</th>
                                        ...
                                        <tbody id="areaResultadosBusqueda">
                                            <?php
                                            $item = 1;
                                            foreach ($inventarios->verHistorialRegistroInventario() as $key) {
                                            ?>
   ...
   <?php include './librerias_js/librerias-inventario-entrada.php' ?>
