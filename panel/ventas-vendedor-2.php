                                ...
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <tbody style="color: gray;">
                                        ...
                                        <tr class="<?php echo $estadoVenta = $key['estado'] == 'CANCELADO'?'btn-danger':'btn-light'; ?>" style="color:black; text-transform: uppercase;">
                                            <td><a href="orden-nueva-venta-2.php?cliente=<?php 
                                            if($key['id_cliente']!=''){
                                                echo $ventas->traerNombreCliente($key['id_cliente']); 
                                            }
                                            else
                                            {
                                               echo $key['cliente'];
                                            }
                                            ?>&id_venta=<?php echo $key['id_venta']; ?>&lista=true"><?php echo $key['id_venta']; ?></a></td>
                                            ...
                                            <td>
                                                ...
                                                if ($key['medio_pago'] == 'CONTRAENTREGA') {
                                                    ...
                                                    <?php if ($key['imagen_comprobante_pago'] != ''){ ?>
                                                        <a href="comprobantes/<?php echo $key['imagen_comprobante_pago']; ?>"> Ver Comprobante</a>
