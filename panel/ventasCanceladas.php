                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered"  width="100%" cellspacing="0">
                                        ...
                                        <tbody style="color: gray;">
                                            <?php
                                            $item = 1;
                                            foreach ($inventarios->verTodoVentaSoporte() as $key) {
                                              if($key[9] == 'CANCELADO' AND $key[6] > '2022-03-00 00:00:00' ){
                                            ?>
                                                <tr>
                                                    <td><?php echo $item; ?></td>
                                                    <td>
                                                        <a href="modal/modalPedidoVentaCancelada.php?id_venta=<?php echo $key['id_venta'];?>&estado=<?php echo $key['estado'];?>" target="_blank"><img style="width: 40px;height: 40px;" src="../imagenes/f.gif"></a>
                                                    </td>
                                            ...
                                            echo 'Numero de Ordenes CANCELADAS a partir de Marzo   =   ';
                                            print_r($item - 1);
                                            ?>
