...
<div id="contenedor_loading">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div style="align-items: center;" class="row justify-content-between p-2">
                        <h1 class="h3 mb-2 text-gray-800"><a href="index.php">General</a> / orden inventario </h1>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">

                            <input type="text" name="fecha_ingreso_inventario" id="fecha_ingreso_inventario">
    ...
    <script>
          $(document).ready(function(){
                      ...
                      $('#fecha_ingreso_inventario').change(function(){
                        var fecha_ingreso_inventario = $('#fecha_ingreso_inventario').val();

                        $.post({
                          type: 'POST',
                          url: 'datos-orden-inventario.php',
                          data: {'fecha_ingreso_inventario':fecha_ingreso_inventario},
                          success: function(r){
                            $('#area').html(r);
                          }
                        });
