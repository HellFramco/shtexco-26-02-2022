            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div style="align-items: center;" class="row justify-content-between p-2">
                        <h1 class="h3 mb-2 text-gray-800"><a href="index.php"></a> / INVENTARIO SUBIDO POR INSUMOS </h1>
                    ...
                    <!-- DataTales Example -->
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <?php 
                                $item = 1;
                                foreach ($inventarios->verTodoInventario('subido') as $key) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <a id="verifica_<?php echo $key['id_inventario']; ?>" class="btn btn-sm btn-" title="verificar inventario"><img src="../imagenes/iconos/verificar.png" alt=""></a>
                                        <script>
