                                ...
                                <tr class="btn-light" style="text-transform: uppercase;">
                                    ...
                                    <td>
                                        ...
                                        <script>
                                            ...
                                            let confirm = prompt('PARA CONTINUAR ESCRIBA LA CLAVE');
                                            if (confirm == '3636') {
                                    ...
                                    <td>
                                        <a id="reintegrar_devoluciones_<?php echo $key['id_inventario']; ?>" class="btn btn-sm btn-" title="Reintegrar Prendas Devueltas de esta referencia" ><img width="15px" src="../imagenes/iconos/reintegro.png" alt=""></a>
                                        <script>
                                    ...
                                    <td>
                                        ...
                                        <script>
                                            document.getElementById('traslado_inventario_<?php echo $key['id_inventario']; ?>').addEventListener('click', function() {
                                              window.open('modal/modalTrasladoBodega.php?id_inventario=<?php echo $key['id_inventario']; ?>&descripcion=<?php echo $key['descripcion']; ?>&color=<?php echo $key['color']; ?>', 'Traslado de prendas de INVENTARIO', 'width=770,height=600, top=354, left=400');
                                            });
                                        </script> 
                                    </td>
