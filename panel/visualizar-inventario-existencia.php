                    ...
                    <div style="align-items: center;" class="row justify-content-between p-2">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table>
                                    <tr>
                                        <th>Referencias JEANS:</th>
                                        <td><?php echo $indicadores->conteoReferenciasPorTipo('JEANS'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Referencias TEJIDO PLANO:</th>
                                        <td><?php echo $indicadores->conteoReferenciasPorTipo('TEJIDO PLANO'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Inventario JEANS:</th>
                                        <td><?php echo $indicadores->conteoInventarioPorTipo('existencia','JEANS'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Inventario TEJIDO PLANO:</th>
                                        <td><?php echo $indicadores->conteoInventarioPorTipo('existencia', 'TEJIDO PLANO'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Inventario Global:</th>
                                        <td><?php echo $indicadores->conteoInventarioTotal('existencia'); ?></td>
                                    </tr>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                        ...
                                        <tbody style="color: gray;">
                                            <?php 
                                $item = 1;
                                foreach ($inventarios->verTodoInventario('existencia') as $key) {
                                ?>
                                <tr class="btn-light" style="text-transform: uppercase;">
                                    ...
                                    <td>
                                        <!-- <a id="reintegrar_<?php echo $key['id_inventario']; ?>" class="btn btn-sm btn-" title="Reintegrar Prendas prestadas de esta referencia" ><img width="15px" src="../imagenes/iconos/reintegro.png" alt=""></a>
                                        <script>
                                            document.getElementById('reintegrar_<?php echo $key['id_inventario']; ?>').addEventListener('click', function() {
                                              window.open('orden-reintegro.php?id_inventario=<?php echo $key['id_inventario']; ?>&descripcion=<?php echo $key['descripcion']; ?>&color=<?php echo $key['color']; ?>', 'ENRUTAR INVENTARIO', 'width=1178,height=740, top=150, left=400');
                                            });
                                        </script> -->
                                    </td>
