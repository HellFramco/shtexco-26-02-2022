                                ...
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th title="" class="text-center">CANTIDAD DE VENTAS</th>
                                            <th title="" class="text-center">TOTAL GENERADO</th>
                                                <th title="" class="text-center">TASA</th>
                                                    <th title="" class="text-center">PAGO INFLUENCER </th>
                                    ...
                                    <tbody style="color: gray;">
                                        ...
                                        foreach ($tienda->ventasInfluencer() as $key) {
                                        ?>
                                        <tr class="btn-light">
                                                ...
                                                <td>$<?php ECHO formatMoney( $key['total_pago'], true); ?></td>
