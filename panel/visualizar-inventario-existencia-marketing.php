                                    ...
                                    require_once("../modelo/db.php");
                                      ...
                                      if (isset($_FILES['imagen'])){
                                        ...
                                        if ($_FILES['imagen']['type']=='image/png' || $_FILES['imagen']['type']=='image/jpeg'){
                                          ...
                                          move_uploaded_file($_FILES["imagen"]["tmp_name"], "modal/imagenesReferencias/".@$_POST['id_inventario'].".jpg");
                                          $consulta = "UPDATE inventarios_productos SET confirma_imagen_subida = '1' WHERE id_inventario =".@$_POST['id_inventario'];
                                                ...
                                                <tr>
                                                    <td>
                                                      ...
                                                      if ($key['confirma_imagen_subida'] == 1) {
                                                        ?>
                                                        <a class="thumbnail" href="modal/modalImagenMarketing.php?id_inventario=<?php echo $key['id_inventario'];?>" target="_blank"><img src="../imagenes/iconos/imagen.png" border="0" /><span><img src="../panel/modal/imagenesReferencias/<?php echo $key['id_inventario']; ?>.jpg"width="0px" height="0px" /></span></a>
                                                        
                                                        <?php
                                                       }
                                                       else{
                                                        echo "<a href='modal/modalImagenMarketing.php?id_inventario=".$key['id_inventario']."' target='_blank'><img style='width: 20px;height: 20px;' src='../imagenes/iconos/2338.png'></a>";
                                                       } ?>
                                                       <script>
