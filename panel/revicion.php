            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div style="align-items: center;" class="row justify-content-between p-2">
                        <h1 class="h3 mb-2 text-gray-800"><a href="index.php">General</a> / Revicion de Inventario </h1>
                        <div class="card">
                            <input type="text" id='referencia'>
                            <input type="Button" id='buscador'>
...
?>
    ...
    <?php include './librerias_js/librerias_estructura.php' ?>
