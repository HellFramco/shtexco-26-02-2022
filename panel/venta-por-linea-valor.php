                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <select class="form-control" onchange="window.location='venta-por-linea-valor.php?anio='+ this.value " name="" id="">
                                ...
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    function formatMoney($number, $fractional=false) {
                                        ...
                                        ?>
                                            <tr class="btn-lightstyle=">
                                                ...
                                                for ($i = 1; $i < 13; $i++) {
                                                    $cuenta = 0;
                                                    foreach ($ventas->ventasValorPorLinea($i,  $key2['numero'], $anio) as $key) {
                                                        $cuenta = 1;
                                                        $totales[$i] = $totales[$i] + $key['total'];
                                                ?>

                                                        <td>$<?php echo formatMoney($key['total'], true) ?> </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[1], true) ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[2], true) ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[3], true) ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[4], true) ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[5], true) ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[6], true) ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[7], true) ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[8], true) ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[9], true) ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[10], true)  ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[11], true)  ?></th>
                                            <th title="" class="text-center">$<?php echo  formatMoney($totales[12], true)  ?></th>
