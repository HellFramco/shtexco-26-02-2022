                        ...
                        ?>
                            <form action="modeloEditarDatosVenta.php" id="data_venta" method="post">
                                ...
                                <div class="col-sm-10">
                                        ...
                                        <legend class="text-center">Editar Direccion de la orden # <strong style="color: blue;"><?php echo @$key['id_venta']; ?></strong></legend>
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    ...
                                                    <select name='direccion' id="direccion" class="form-control text-center">
                                                        ...
                                                        <?php 
                                                        foreach ($clientes->direccionCliente($_GET['id_cliente']) as $key) {
                                                        ?>
                                                        <option value="<?php echo $key['direccion'] ?>"><?php echo $key['direccion'] ?></option>
                                                        <?php 
                                                        }
                            ...
                            <div class="col-sm-12">
                                        <input type="hidden" name="accion" value="editarDireccionVenta">
                                        <input type="hidden" name="venta" value="<?php echo $id_venta; ?>">
                                        <br><br><br>
                                        <input type="submit" id="Actualizar" class="btn btn-success text-center" value="Actualizar Direccion de la orden" /> 
