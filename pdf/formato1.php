...
$precio_unitario=0;
                  ...
                  if($total4 > 0) {
                      while ($data4 = $modules4->fetch(PDO::FETCH_ASSOC)) {
                       ...
                       $dato8= $data3['talla20'];
                       $precio_total = $precio_lista / $suma;
                    ...
                    <td style="font-size:13px">
                    <span style="font-size: xx-small;" >'.formatMoney($precio_total, true).'</span>
                    </td>
...
<table cellspacing="0" cellpadding="1" border="1" align="center" style="line-height: 80%;">
    <tr>
        ...
        <td rowspan="2" style="background-color:$color; font-size:12px">
        <span style="font-size: xx-small;">UBI</span>
        </td>
        <td rowspan="2" style="background-color:$color; font-size:12px">
        <span style="font-size: xx-small;">COLOR</span>
        </td>
        <td colspan="8 " style="background-color:$color; font-size:12px">
    ...
    <tr>
        ...
        <span style="font-size: xx-small;">18/39</span>
        </td>
        <td>
